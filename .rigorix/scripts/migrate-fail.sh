...
echo "Attempting ALTER TABLE customers ADD COLUMN status TEXT NOT NULL ..."
if pg -v ON_ERROR_STOP=1 -c "ALTER TABLE customers ADD COLUMN status TEXT NOT NULL" 2>/tmp/migrate-fail.err; then
